...
> **Status:** v1.0 (drafted 2026-05-25, as part of the iter-5 post-mortem on golden-case coverage).
...
> **Companion documents:**
> - [`EVALUATION_COVERAGE.md`](./EVALUATION_COVERAGE.md) — the per-dimension coverage matrix at the current 25-case state.
...
*This document is part of the PACCA v2.3 harness-engineering cycle documentation set. Updated when the dataset crosses a threshold (50 / 100 / 300 / 500) or when a framework calculation changes. Last updated: 2026-05-25.*
